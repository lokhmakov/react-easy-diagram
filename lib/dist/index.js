...
var VisualComponentState = /** @class */ (function () {
    function VisualComponentState(component) {
        ...
        mobx.makeObservable(this, {
            _component: mobx.observable.ref,
            _settings: mobx.observable,
...
var BackgroundDefault = mobxReactLite.observer(function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: 'react_fast_diagram_Background_Default', style: {
...
var useNotifyRef = function (init) {
    var _a = React.useState(0); _a[0]; var forceUpdate = _a[1];
...
var useLinkUserInteraction = function (linkState) {
    ...
    var selectionHandledRef = React.useRef(false);
    var selectionTimeoutRef = React.useRef(null);
    ...
    var bind = reactUseGesture.useGesture(handlers, {
...
var LinkWrapper = mobxReactLite.observer(function (_a) {
    var link = _a.link;
    var bind = useLinkUserInteraction(link).bind;
    return (React__default['default'].createElement("g", null,
        React__default['default'].createElement(link.componentDefinition.component, { bind: bind, entity: link, settings: link.componentDefinition.settings })));
});

var LinksLayer = mobxReactLite.observer(function (_a) {
    var linksStore = _a.linksStore;
    var rootStore = useRootStore();
    return (React__default['default'].createElement("svg", { className: "react_fast_diagram_Layer" },
        React__default['default'].createElement("defs", null, rootStore.linksSettings.svgMarkers.map(function (Marker, i) { return React__default['default'].createElement(Marker, { key: i }); })),
        Array.from(linksStore.links).map(function (_a) {
            _a[0]; var link = _a[1];
            return (React__default['default'].createElement(LinkWrapper, { key: link.id, link: link }));
        }),
        React__default['default'].createElement(LinkWrapper, { key: '__creation__', link: linksStore.linkCreation })));
});
...
function useCursor(active, cursor, ref) {
    var cursorBeforeSetRef = React.useRef('');
    React.useEffect(function () {
...
var useNodeUserInteraction = function (nodeState) {
    var _a, _b;
    var rootStore = useRootStore();
    var interactionActiveRef = React.useRef(false);
    var selectOnLongTapRef = React.useRef(null);
    var cancelSelectOnLongTap = React.useCallback(function () {
    ...
    var userInteractionElemRef = React.useRef(null);
    var handlers = React.useMemo(function () { return ({
        onDrag: function (_a) {
    ...
    reactUseGesture.useGesture(handlers, {
...
var NodeWrapper = mobxReactLite.observer(function (_a) {
    var node = _a.node;
    var userInteractionElemRef = useNodeUserInteraction(node);
    var renderedPortsContextValue = usePortsCleanUp(node);
    return (React__default['default'].createElement(NodeContext.Provider, { value: node },
        React__default['default'].createElement(RenderedPortsComponentsContext.Provider, { value: renderedPortsContextValue },
            React__default['default'].createElement("div", { id: node.id, className: className$1, style: {
                    transform: "translate(" + node.position[0] + "px, " + node.position[1] + "px)",
                    zIndex: node.selected ? 10 : undefined,
                }, ref: node.ref },
                React__default['default'].createElement(node.componentDefinition.component, { draggableRef: userInteractionElemRef, entity: node, settings: node.componentDefinition.settings })))));
});
var NodeContext = React__default['default'].createContext(null);
var RenderedPortsComponentsContext = React__default['default'].createContext({ render: function () { return undefined; }, unrender: function () { return undefined; } });
...
var usePortsCleanUp = function (node) {
    ...
    var renderedPortsContextValue = React.useMemo(function () { return ({
        render: function (id) {
    ...
    React.useEffect(function () {
        ...
        mobx.action(function () { return extraPortsIds.forEach(function (id) { return node.removePort(id); }); });
    }, [renderedPortsRef.current]);
    return renderedPortsContextValue;
};

var NodesLayer = mobxReactLite.observer(function (_a) {
    var nodesStore = _a.nodesStore;
    var rootStore = useRootStore();
    React.useEffect(function () {
        rootStore.diagramState.zoomToFit();
    }, []);
    return (React__default['default'].createElement("div", { className: "react_fast_diagram_Layer" }, Array.from(nodesStore.nodes).map(function (_a) {
        _a[0]; var node = _a[1];
        return (React__default['default'].createElement(NodeWrapper, { key: node.id, node: node }));
    })));
});
...
var useDiagramUserInteraction = function () {
    var diagramState = useRootStore().diagramState;
    var cancelGesture = React.useCallback(function (event) { return event.target !== diagramState.diagramInnerRef.current; }, [diagramState.diagramInnerRef]);
    ...
    reactUseGesture.useGesture(__assign(__assign(__assign({}, dragHandlers), pinchHandlers), wheelHandler), {
        domTarget: diagramState.diagramInnerRef,
        eventOptions: { passive: false },
    });
};

var MiniControlWrapper = mobxReactLite.observer(function () {
    var rootStore = useRootStore();
    var minicontrolComponentState = rootStore.diagramSettings.miniControlComponentState;
    return (minicontrolComponentState.component && (React__default['default'].createElement(minicontrolComponentState.component, { rootStore: rootStore, settings: minicontrolComponentState.settings })));
});
...
var InnerDiagram = mobxReactLite.observer(function (props) {
    var rootStore = useRootStore();
    ...
    return (React__default['default'].createElement("div", { ref: rootStore.diagramState.diagramInnerRef, style: __assign({}, props.diagramStyles), className: 'react_fast_diagram_DiagramInner' },
        React__default['default'].createElement(BackgroundWrapper, null),
        React__default['default'].createElement("div", { className: 'react_fast_diagram_DiagramInner_DraggablePart', style: {
                transform: generateTransform(offset, zoom),
            } },
            React__default['default'].createElement(LinksLayer, { linksStore: rootStore.linksStore }),
            React__default['default'].createElement(NodesLayer, { nodesStore: rootStore.nodesStore })),
        React__default['default'].createElement(MiniControlWrapper, null)));
});
...
var RubbishBinIcon = function () { return (React__default['default'].createElement("svg", { viewBox: '0 0 24 24' },
    React__default['default'].createElement("path", { d: "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zm2.46-7.12l1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4z" }))); };
var CopyIcon = function () { return (React__default['default'].createElement("svg", { viewBox: '0 0 24 24' },
    React__default['default'].createElement("path", { d: 'M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm-1 4H8c-1.1 0-1.99.9-1.99 2L6 21c0 1.1.89 2 1.99 2H19c1.1 0 2-.9 2-2V11l-6-6zM8 21V7h6v5h5v9H8z' }))); };
var FilterCenterFocusIcon = function () { return (React__default['default'].createElement("svg", { viewBox: '0 0 24 24' },
    React__default['default'].createElement("path", { d: "M5 15H3v4c0 1.1.9 2 2 2h4v-2H5v-4zM5 5h4V3H5c-1.1 0-2 .9-2 2v4h2V5zm14-2h-4v2h4v4h2V5c0-1.1-.9-2-2-2zm0 16h-4v2h4c1.1 0 2-.9 2-2v-4h-2v4zM12 9c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" }))); };

var MiniControlDefault = mobxReactLite.observer(function (_a) {
    ...
    if (Object.values(settings.buttons).every(function (v) { return v === false; }))
        return null;
    return (React__default['default'].createElement("div", { className: 'react_fast_diagram_Minicontrol_Default', style: __assign(__assign({}, getOffsetStyles(settings)), settings === null || settings === void 0 ? void 0 : settings.containerStyle) },
        settings.buttons.deleteSelection &&
            rootStore.selectionState.selectedItems.length > 0 && (React__default['default'].createElement(Button, { size: settings.buttonsSize, onClick: function () {
                return rootStore.commandExecutor.execute(removeSelectedCommand);
            } },
            React__default['default'].createElement(RubbishBinIcon, null))),
        settings.buttons.cloneSelectedNodes &&
            rootStore.selectionState.selectedItems.length > 0 && (React__default['default'].createElement(Button, { size: settings.buttonsSize, onClick: function () {
                return rootStore.commandExecutor.execute(cloneSelectedNodesCommand);
            } },
            React__default['default'].createElement(CopyIcon, null))),
        settings.buttons.zoomIn && (React__default['default'].createElement(Button, { size: settings.buttonsSize, onClick: rootStore.diagramState.zoomIn, children: '+' })),
        settings.buttons.zoomOut && (React__default['default'].createElement(Button, { size: settings.buttonsSize, onClick: rootStore.diagramState.zoomOut, children: '-' })),
        settings.buttons.zoomToFit && (React__default['default'].createElement(Button, { size: settings.buttonsSize, onClick: rootStore.diagramState.zoomToFit },
            React__default['default'].createElement(FilterCenterFocusIcon, null)))));
});
...
var Button = function (props) { return (React__default['default'].createElement("button", { onClick: props.onClick, className: 'react_fast_diagram_Minicontrol_Default_Btn', style: {
        width: props.size + 'px',
...
var LinkDefault = mobxReactLite.observer(function (_a) {
    ...
    return (React__default['default'].createElement("g", null,
        React__default['default'].createElement("path", { d: path.svgPath, stroke: color, strokeWidth: finalSettings.strokeWidth, fill: 'none', strokeLinecap: 'round', markerStart: getMarkerBasedOnState(finalSettings.markerStart, entity.selected, entity.hovered), markerEnd: getMarkerBasedOnState(finalSettings.markerEnd, entity.selected, entity.hovered) }),
        React__default['default'].createElement("path", __assign({ d: path.svgPath, stroke: color, strokeWidth: '5' }, bind(), { pointerEvents: 'auto', fill: 'none', strokeOpacity: entity.hovered && finalSettings.enableHoverEffect ? 0.22 : 0 }))));
});
...
var CircleMarker = function (props) {
    ...
    return (React__default['default'].createElement("marker", { id: finalSettings.id, overflow: 'visible', markerUnits: 'userSpaceOnUse' },
        React__default['default'].createElement("circle", { r: finalSettings.radius, style: finalSettings.style })));
};
function createCircleMarker(settings) {
    return function () { return React__default['default'].createElement(CircleMarker, __assign({}, settings)); };
}
var ArrowMarker = function (props) {
    ...
    return (React__default['default'].createElement("marker", { id: finalSettings.id, overflow: 'visible', markerUnits: 'userSpaceOnUse', refX: '-0.5', orient: 'auto' },
        React__default['default'].createElement("path", { d: "M 0 0 -" + finalSettings.width + " -" + finalSettings.height / 2 + " -" + finalSettings.width + " " + finalSettings.height / 2 + " z", style: finalSettings.style })));
};
function createArrowMarker(settings) {
    return function () { return React__default['default'].createElement(ArrowMarker, __assign({}, settings)); };
}
...
var NodeLabel = mobxReactLite.observer(function (_a) {
    var node = _a.node;
    return React__default['default'].createElement("span", null, node.label ? node.label : node.id);
});
...
var Port = mobxReactLite.observer(function (props) {
    var node = React.useContext(NodeContext); // node should already exist
    ...
    return (React__default['default'].createElement("div", __assign({ style: positionStyles, id: portState.fullId, className: className, ref: portState.ref, key: portState.fullId }, bind()),
        React__default['default'].createElement(portState.componentDefinition.component, { entity: portState, settings: portState.componentDefinition.settings })));
});
...
var useRenderingReport = function (id) {
    var _a = React.useContext(RenderedPortsComponentsContext), render = _a.render, unrender = _a.unrender;
    React.useEffect(function () {
        render(id);
...
var Node = mobxReactLite.observer(function (_a) {
    ...
    return (React__default['default'].createElement("div", { ref: draggableRef, className: 'react_fast_diagram_Node_Default', style: finalStyles },
        React__default['default'].createElement(finalSettings.innerNode, { node: entity }),
        Array.isArray(finalSettings.ports) &&
            finalSettings.ports.map(function (p) { return React__default['default'].createElement(Port, __assign({}, p, { key: p.id })); })));
});
...
var NodeState = /** @class */ (function () {
    function NodeState(rootStore, id, state) {
        ...
        mobx.reaction(function () { return [_this._id, _this._label, _this._extra, _this._type]; }, function () {
...
var PortInnerDefault = mobxReactLite.observer(function (_a) {
...
var RootStoreContext = React__default['default'].createContext(null);
function Diagram(props) {
    var rootStore = React.useMemo(function () {
        var _a, _b, _c, _d;
    ...
    return (React__default['default'].createElement(RootStoreContext.Provider, { value: rootStore },
        React__default['default'].createElement(InnerDiagram, null)));
}
Diagram.displayName = 'Diagram';

var useRootStore = function () { return React.useContext(RootStoreContext); };

var BackgroundWrapper = mobxReactLite.observer(function () {
    var _a = useRootStore(), diagramSettings = _a.diagramSettings, diagramState = _a.diagramState;
    return (React__default['default'].createElement("div", { className: 'react_fast_diagram_BackgroundWrapper' },
        React__default['default'].createElement(diagramSettings.backgroundComponentState.component, { diagramOffset: diagramState.offset, diagramZoom: diagramState.zoom, settings: diagramSettings.backgroundComponentState.settings })));
});

var positionValues = ['left', 'top', 'right', 'bottom'];

var PortsContainer = mobxReactLite.observer(function (_a) {
    ...
    var portsModified = React.useMemo(function () {
        return ports &&
    ...
    return (React__default['default'].createElement("div", { className: className, style: __assign(__assign(__assign({ 
            // @ts-ignore
            '--gap': gapBetweenPorts }, style), positionStyle), offsetFromOriginPositionStyle) }, portsModified &&
        portsModified.map(function (port) { return React__default['default'].createElement(Port, __assign({}, port, { key: port.id })); })));
});
...
function createPortsContainer(settings) {
    return function (props) { return (React__default['default'].createElement(PortsContainer, __assign({}, __assign(__assign({}, defaultPortsContainerSettings), settings), props))); };
}
...
var useDiagram = function (initState, settings) {
    ...
    var obj = React.useMemo(function () { return ({
        Diagram: function () { return (React__default['default'].createElement(Diagram, { storeRef: storeRef, initState: initState, settings: settings })); },
        storeRef: storeRef,
    }); }, []);
    return obj;
};
...
exports.BackgroundWrapper = BackgroundWrapper;
exports.Button = Button;
exports.Callbacks = Callbacks;
exports.CommandExecutor = CommandExecutor;
exports.CopyIcon = CopyIcon;
exports.DISABLED_USER_SELECT_CSS_CLASS = DISABLED_USER_SELECT_CSS_CLASS;
exports.Diagram = Diagram;
exports.DiagramSettings = DiagramSettings;
exports.DiagramState = DiagramState;
...
exports.InnerDiagram = InnerDiagram;
exports.LinkCreationState = LinkCreationState;
exports.LinkDefault = LinkDefault;
exports.LinkPointEndpointState = LinkPointEndpointState;
exports.LinkPortEndpointState = LinkPortEndpointState;
exports.LinkState = LinkState;
exports.LinkWrapper = LinkWrapper;
exports.LinksLayer = LinksLayer;
exports.LinksSettings = LinksSettings;
exports.LinksStore = LinksStore;
exports.MiniControlWrapper = MiniControlWrapper;
exports.Node = Node;
exports.NodeContext = NodeContext;
exports.NodeLabel = NodeLabel;
exports.NodeState = NodeState;
exports.NodeWrapper = NodeWrapper;
exports.NodesLayer = NodesLayer;
exports.NodesSettings = NodesSettings;
exports.NodesStore = NodesStore;
exports.Port = Port;
exports.PortInnerDefault = PortInnerDefault;
exports.PortState = PortState;
exports.PortsSettings = PortsSettings;
exports.RenderedPortsComponentsContext = RenderedPortsComponentsContext;
exports.RootStore = RootStore;
exports.RootStoreContext = RootStoreContext;
exports.RubbishBinIcon = RubbishBinIcon;
exports.SelectionState = SelectionState;
exports.UserInteractionSettings = UserInteractionSettings;
exports.VisualComponentState = VisualComponentState;
exports.VisualComponentWithDefault = VisualComponentWithDefault;
exports.VisualComponents = VisualComponents;
exports.addPoints = addPoints;
exports.arePointsEqual = arePointsEqual;
exports.areTranformationsEqual = areTranformationsEqual;
exports.canDragGestureBeTapInstead = canDragGestureBeTapInstead;
exports.clampValue = clampValue;
exports.className = className$1;
exports.cloneSelectedNodesCommand = cloneSelectedNodesCommand;
exports.commandC = commandC;
exports.commandM = commandM;
exports.componentDefaultType = componentDefaultType;
exports.coordinateFromPoint = coordinateFromPoint;
exports.createArrowMarker = createArrowMarker;
exports.createCircleMarker = createCircleMarker;
exports.createCrossesImageGenerator = createCrossesImageGenerator;
exports.createCurvedLinkPathConstructor = createCurvedLinkPathConstructor;
exports.createDefaultBackground = createDefaultBackground;
exports.createDefaultMiniControl = createDefaultMiniControl;
exports.createDotsImageGenerator = createDotsImageGenerator;
exports.createFullPortId = createFullPortId;
exports.createGridImageGenerator = createGridImageGenerator;
exports.createInputHorizontalNode = createInputHorizontalNode;
exports.createInputOutputHorizontalNode = createInputOutputHorizontalNode;
exports.createInputOutputVerticalNode = createInputOutputVerticalNode;
exports.createInputVerticalNode = createInputVerticalNode;
exports.createLinkDefault = createLinkDefault;
exports.createLinkPath = createLinkPath;
exports.createNode = createNode;
exports.createOutputHorizontalNode = createOutputHorizontalNode;
exports.createOutputVerticalNode = createOutputVerticalNode;
exports.createPortInnerDefault = createPortInnerDefault;
exports.createPortsContainer = createPortsContainer;
exports.createStarNode = createStarNode;
exports.createStraightLinkPathConstructor = createStraightLinkPathConstructor;
exports.createVector = createVector;
exports.deepCopy = deepCopy;
exports.disableNodeUserInteractionClassName = disableNodeUserInteractionClassName;
exports.distanceBetweenPoints = distanceBetweenPoints;
exports.enableNodeUserInteractionClassName = enableNodeUserInteractionClassName;
exports.errorResult = errorResult;
exports.errorValueResult = errorValueResult;
exports.eventPathContainsClass = eventPathContainsClass;
exports.generateTransform = generateTransform;
exports.getDegree = getDegree;
exports.getRadian = getRadian;
exports.guid = guid;
exports.guidForcedUniqueness = guidForcedUniqueness;
...
exports.linkCreationComponentType = linkCreationComponentType;
exports.linkPortEndpointsEquals = linkPortEndpointsEquals;
exports.multiplyPoint = multiplyPoint;
exports.portPositionValues = portPositionValues;
exports.positionValues = positionValues;
exports.removeSelectedCommand = removeSelectedCommand;
exports.removeSelectedLinksCommand = removeSelectedLinksCommand;
exports.removeSelectedNodesCommand = removeSelectedNodesCommand;
exports.roundPoint = roundPoint;
exports.subtractPoints = subtractPoints;
exports.successResult = successResult;
exports.successValueResult = successValueResult;
exports.useCursor = useCursor;
exports.useDiagram = useDiagram;
exports.useDiagramCursor = useDiagramCursor;
exports.useDiagramDragHandlers = useDiagramDragHandlers;
exports.useDiagramPinchHandlers = useDiagramPinchHandlers;
exports.useDiagramUserInteraction = useDiagramUserInteraction;
exports.useDiagramWheelHandler = useDiagramWheelHandler;
exports.useLinkUserInteraction = useLinkUserInteraction;
exports.useNodeUserInteraction = useNodeUserInteraction;
exports.useNotifyRef = useNotifyRef;
exports.usePortUserInteraction = usePortUserInteraction;
exports.useRelativePositionStyles = useRelativePositionStyles;
exports.useRootStore = useRootStore;
exports.useUpdateOrCreatePortState = useUpdateOrCreatePortState;
exports.useUserAbilityToSelectSwitcher = useUserAbilityToSelectSwitcher;
